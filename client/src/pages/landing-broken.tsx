      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <Link href="/providers">
              <Button className="md:hidden bg-[hsl(207,90%,54%)] hover:bg-[hsl(207,90%,44%)]">
                View All Providers
              </Button>
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We're revolutionizing healthcare delivery with trusted professionals, secure technology, and personalized care
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center group">
              <div className="w-16 h-16 bg-[hsl(207,90%,54%)] rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
                <UserCheck className="h-8 w-8 text-white" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-4">Licensed Professionals</h3>
              <p className="text-gray-600">
                All providers are licensed healthcare professionals with verified credentials and insurance coverage
              </p>
            </div>
            
            <div className="text-center group">
              <div className="w-16 h-16 bg-[hsl(159,100%,34%)] rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
                <Activity className="h-8 w-8 text-white" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-4">Quality Care</h3>
              <p className="text-gray-600">
                Comprehensive in-home medical services with professional equipment and personalized treatment plans
              </p>
            </div>
            
            <div className="text-center group">
              <div className="w-16 h-16 bg-[hsl(259,78%,60%)] rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
                <DollarSign className="h-8 w-8 text-white" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-4">Transparent Pricing</h3>
              <p className="text-gray-600">
                Get personalized quotes based on your specific needs with clear pricing and insurance guidance
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              { number: 2, title: "Get Quotes", description: "Contact providers for personalized quotes and virtual consultations tailored to your specific needs.", color: "bg-[hsl(159,100%,34%)]" },
              { number: 3, title: "Book Appointment", description: "Schedule your appointment at a convenient time with secure payment and confirmation.", color: "bg-[hsl(259,78%,60%)]" },
              { number: 4, title: "Receive Care", description: "Your provider visits your home with all necessary equipment for professional healthcare services.", color: "bg-orange-500" }
            ].map((step) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center text-gray-400">
                  <span className="text-sm">📞 1-800-MEDLINK (633-5465)</span>
                </div>
                <div className="flex items-center text-gray-400">
                  <span className="text-sm">✉️ support@medlinkcalgary.ca</span>
                </div>
                <div className="flex items-center text-gray-400">
                  <span className="text-sm">📍 Calgary, Alberta, Canada</span>
                </div>
              </div>
            ...
            <div className="col-span-1">
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><Link href="/services" className="hover:text-white transition-colors">Palliative Care</Link></li>
                <li><Link href="/services" className="hover:text-white transition-colors">Laboratory Tests</Link></li>
              </ul>
            </div>
